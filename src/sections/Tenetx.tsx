  ...
  return (
    <section className="py-24 bg-white px-6 md:px-24">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-4 items-baseline mb-12 border-t-3 border-tenetx-primary pt-8">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <li key={idx} className="flex items-start gap-3">
                  <div className="mt-1 bg-tenetx-primary/10 p-1 rounded-full">
            ...
            <button className="flex items-center gap-4 text-tenetx-primary font-rajdhani font-bold tracking-widest uppercase group border border-tenetx-primary px-8 py-4 rounded-full hover:bg-tenetx-primary hover:text-white transition-all">
              Explore TENETX 
          ...
          <div className="lg:w-1/2">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-tenetx-light rounded-[16px] p-8 md:p-12 shadow-sm border border-tenetx-primary/10"
            >
        ...
        {/* Key Facts Strip */}
        <div className="mt-16 bg-tenetx-light py-8 px-12 rounded-[12px] flex flex-wrap justify-between gap-8 border border-tenetx-primary/10">
          {[
            "7–8B Parameters",
            "Offline Deployment",
