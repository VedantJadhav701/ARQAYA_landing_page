      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((industry, idx) => (
            ...
            >
              <Link href={`/industries#${industry.slug}`} className="editorial-card group block">
                {/* Background Image */}
                <img
                  src={industry.image}
                  alt={industry.alt}
                ...
                />
                {/* Gradient Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/30 to-black/10 transition-all duration-300 group-hover:from-black/70" />
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-between z-10">
                  ...
                  <div>
                    <h3 className="font-serif text-white text-[24px] mb-4">
                      {industry.name}
                    </h3>
                    <p className="font-sans text-[11px] text-white/60 mb-6 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {industry.alt}
                    </p>
