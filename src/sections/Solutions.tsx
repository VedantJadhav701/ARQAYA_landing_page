        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {solutions.map((sol, idx) => (
            <motion.div
              ...
              className="bg-white rounded-lg p-10 shadow-sm border border-gray-mid relative group overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <p className="font-sans text-text-mid text-[16px] mb-8 relative z-10 leading-relaxed">{sol.desc}</p>
              
              <Link href="/what-we-do" className="text-gold font-rajdhani font-bold tracking-widest text-[12px] uppercase flex items-center gap-2 group-hover:gap-3 transition-all cursor-pointer">
